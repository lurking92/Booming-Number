...
BROADCAST_PORT = 4567  # Change to 4568 for the second client
SERVER_PORT = 1234     # Change to 1235 for the second client
MAXLINE = 1024
...
def communicate_with_server():
    ...
    try:
        ...
        update_chat_log("client1 connected to server.")
